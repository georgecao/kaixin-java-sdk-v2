...
<jsp:useBean id="connection" scope="session" class="kx4j.KxSDK" />
<%
...
<ul>
    ...
    <li><a href="callback.jsp?access_token=<%= access_token %>&method=relation">/friends/relationship　获取两个用户间的好友关系 </a></li>
    <li><a href="callback.jsp?access_token=<%= access_token %>&method=status">/app/status　 获取用户安装组件的状态</a></li>
    <li><a href="callback.jsp?access_token=<%= access_token %>&method=friendstatus">/app/friends　获取当前用户安装组件的好友uid列表 </a></li>
    <li><a href="callback.jsp?access_token=<%= access_token %>&method=invited">/app/invited　获取某用户邀请成功的好友uid列表</a></li>
    <li><a href="callback.jsp?access_token=<%= access_token %>&method=album_show">/album/show　获取某照片专辑列表</a></li>
    <li><a href="callback.jsp?access_token=<%= access_token %>&method=album_create">/album/create　创建一个照片专辑列表</a></li>
        ...
        <ul>
            <li>
                <form action="callback.jsp" method="post" >
                    ...
                    <p><label>save_to_album: </label><input class="text" name="save_to_album" type="text" value="1"/></p>
                    ...
                    <p><label>sync_status: </label><input class="text" name="sync_status" type="text" value="1"/></p>
                    <p><label>pic:</label><input type="file" name="pic" /></p>
